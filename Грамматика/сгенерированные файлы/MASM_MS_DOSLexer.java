...
public class MASM_MS_DOSLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"NUMBER", "INT", "REAL", "DB", "DW", "DD", "DF", "DP", "DQ", "DT", "MOV", 
			"XCLHG", "ADD", "SUB", "JMP", "DATA", "CODE", "END", "ID", "LETTER", 
			"DIGIT", "WS"
		};
	}
	...
	public MASM_MS_DOSLexer(CharStream input) {
		super(input);
